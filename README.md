...
## 🛠 Features (ویژگی‌ها)
- **Core Engine (Moteur)**: Custom-built Shunting Yard parser for secure and accurate math evaluation. (v1.6.0)
  (موتور هسته: پارسر اختصاصی Shunting Yard برای محاسبات دقیق و امن.)
- **Memory Functions**: Store, Recall, Add, and Subtract values with visual indicators.
  (توابع حافظه: ذخیره، بازخوانی، جمع و تفریق مقادیر با نشانگر تصویری.)
...
- `services/`: Pure logic functions (Tokenizing & Parsing).
